...
**Primera muestra para revisión del cliente** (decidir qué se queda y qué se cambia).

## Ver la web
- En vivo (GitHub Pages): ver la pestaña **Settings → Pages** del repo para el enlace.
- Archivo principal: `index.html` (una sola página, sin dependencias/instalación).
...
Contacto (WhatsApp): +58 414-7676618
